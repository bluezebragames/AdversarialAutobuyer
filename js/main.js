...
Game.checkTutorial = function() {
    if(Game.wantTutorial)
    {
        ...
        case 0:
            ...
            break;
        case 2:
            Game.tutorialText = "Ptro: I'm The Ptrocanfer, but you may call me The Ptrocanfer for short.  It's pronounced 'the TRO-can-fer' for all you pronunciation nerds.<br>";
        ...
        case 6:
            ...
            break;
        case 8:
            Game.tutorialText = "Ptro: No?  Good!  Anyway, to start this game off you'd probably be best clicking on that piece of paper off to the left a few times.<br>";
            setTimeout(Game.displaySlowText, 5000);
            Game.tutorialLevel++;
            break;
        case 10:
        ...
        case 46:
            ...
            break;
        case 48:
            Game.tutorialText = "Ptro: And by close enough of course I mean that you need TWO '" + Game.buildings[1].called + "'s!<br>";
            setTimeout(Game.displaySlowText, 5000);
            Game.tutorialLevel++;
            break;
        case 50:
            if(Game.buildings[1].howMany >= 2)
            {
                Game.tutorialText = "Ptro: Ok, ok.<br>";
                setTimeout(Game.displaySlowText, 5000);
                Game.tutorialLevel++;
            }
            break;
